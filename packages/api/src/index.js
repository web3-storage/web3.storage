...
import { authLoginPost, authKeysPost, withAuth } from './auth.js'
...
router.post('/auth/login', withCorsHeaders(authLoginPost))
router.post('/auth/keys', withCorsHeaders(withAuth(authKeysPost)))
