...
heroku apps:create web3-storage-production --team=web3-storage
...
heroku addons:create heroku-postgresql:premium-4 --app=web3-storage-production --name=web3-storage-production-0

# Add replica
heroku addons:create heroku-postgresql:premium-4 --app=web3-storage-production --name=web3-storage-production-replica-0 --follow $(heroku config:get DATABASE_URL --app=web3-storage-production)
...
heroku pg:psql web3-storage-production-0 --app=web3-storage-production
# ...run schema SQL from /packages/db/tables.sql
# ...run schema SQL from /packages/db/fdw.sql with credentials replaced
# ...run schema SQL from /packages/db/cargo.sql
# ...run schema SQL from /packages/db/functions.sql
...
heroku apps:create web3-storage-pgrest-production --buildpack https://github.com/PostgREST/postgrest-heroku --team=web3-storage

# Bump dyno sizes
heroku dyno:resize web=standard-1x --app web3-storage-pgrest-staging
heroku dyno:resize web=standard-2x --app web3-storage-pgrest-production
...
heroku pg:credentials:create web3-storage-production-0 --name=web_anon --app=web3-storage-production
heroku pg:credentials:create web3-storage-production-0 --name=authenticator --app=web3-storage-production
heroku pg:credentials:create web3-storage-production-0 --name=web3_storage --app=web3-storage-production
...
heroku pg:psql web3-storage-production-0 --app=web3-storage-production < grant-postgrest.sql
...
heroku config:set DB_URI=$(heroku config:get DATABASE_URL --app=web3-storage-production) --app=web3-storage-pgrest-production
# Obtain secret from 1password vault!
heroku config:set JWT_SECRET="supersecret" --app=web3-storage-pgrest-staging
heroku config:set JWT_SECRET="supersecret" --app=web3-storage-pgrest-production
...
heroku git:remote --app=web3-storage-pgrest-production
git push heroku main
...
heroku domains:add db.web3.storage --app=web3-storage-pgrest-production
...
heroku certs:auto:enable --app=web3-storage-pgrest-production

# dagcargo #####################################################################

# Add dagcargo user
heroku pg:credentials:create web3-storage-staging-0 --name=dagcargo --app=web3-storage-staging
heroku pg:credentials:create web3-storage-production-0 --name=dagcargo --app=web3-storage-production

# Grant privileges to dagcargo user
heroku pg:psql web3-storage-staging-0 --app=web3-storage-staging < grant-dagcargo.sql
heroku pg:psql web3-storage-production-0 --app=web3-storage-production < grant-dagcargo.sql

# stats ########################################################################

# Add stats user for ad-hoc reporting (only needs production access)
heroku pg:credentials:create web3-storage-production-0 --name=stats --app=web3-storage-production

# Grant RO privileges to stats user
heroku pg:psql web3-storage-production-0 --app=web3-storage-production < grant-stats.sql
