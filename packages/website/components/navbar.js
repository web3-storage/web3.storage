  ...
  return (
    <nav className={clsx(bgColor, "w-full z-40")} ref={containerRef}>
      ...
      >
        ...
        <div className="flex flex-1 items-center justify-end" style={{ minHeight: 52 }}>
          {ITEMS.map((item) => (
      ...
      >
        <div className="flex flex-col align-middle text-center mt-4">
          ...
          >
            <span id="close-menu-text" hidden>Close Menu</span>
            <Cross width="48" height="48" aria-hidden="true" focusable="false" />
          </button>
        </div>
      </div>
      )}
