...
import { useProgress as useUploadProgress, STATUS, FilesContext } from '../components/upload'
...
export default function Upload() {
  ...
  const uploadFiles = useCallback(async () => {
    ...
    try {      
      const uploadFile = async (/** @type import('../components/upload').FileProgress} */ file) => {
        try {
      ...
      <div className="max-w-xl mx-auto">
        <div>
          <div className="flex items-center justify-between flex-wrap">
            <h2 className={clsx(finished && "mb-5 sm:mb-0")}>
              Upload File(s)
            </h2>
            {
              finished && (
          ...
          >
            <div className="mb-8 w-full">
              ...
              />
              <div className="w-full flex p-6 relative flex-wrap sm:flex-nowrap">
                <div
                  className={clsx(
                ...
                <Button
                    variant="light"
                    wrapperClassName="flex relative z-1 max-h-16 w-full sm:w-auto mb-5 sm:mb-0"
                    className="leading-5 border-2 w-full"
                    onClick={openInput}
                    small={false}
                    disabled={uploading}
                  >
            ...
            <div className="flex w-full">
              ...
              <div className={clsx("ml-8 w-full pt-1", { "hidden": !uploading && !finished })}>
                ...
                <div className="flex justify-between leading-7 text-sm flex-wrap sm:flex-nowrap">
                  ...
                  <div>{`${prettyBytes(progress.completed.size).replace(" ", "")}/${prettyBytes(progress.total.size).replace(" ", "")}`}</div>
                </div>
              </div>
            </div>
            <div>
