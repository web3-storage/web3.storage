...
<Img src="/images/docs/image-gallery-example.gif" alt="Animated screen capture of the example app, showing a user uploading an image and viewing it in their gallery." width="1440" height="875" />
