...
describe('cron - pins', () => {
  it('can be executed', async () => {
    ...
    assert.match(stderr, /pins:updatePinStatuses ⏳ Checking status of 3 CIDs/)
    assert.match(stderr, /pins:updatePinStatuses 📌 bafy1@test-peer-id: Pinning => Pinned/)
    assert.match(stderr, /pins:updatePinStatuses 📌 bafy1@test-peer-id-2: Pinning => Pinned/)
    ...
    assert.match(stderr, /pins:updatePinStatuses ⏳ Updating 4 pins/)
    assert.match(stderr, /pins:updatePinStatuses ✅ Updated 4 pins/)
